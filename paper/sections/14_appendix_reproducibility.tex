...
build, and the cloud topology unspecified; any of those layers can
drift between machines and change numerical results. The stack we use
closes those gaps.
...
Zarr stores, the throughput sweeps, and the gradient receipt) totals
a few megabytes and is published as a separate artifact distribution
rather than committed to the source repository, available
