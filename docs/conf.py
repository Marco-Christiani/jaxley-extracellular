...
project = "jaxley-extracellular"
copyright = "2025, Marco Christiani"
...
html_theme = "furo"
html_title = "jaxley-extracellular"

html_theme_options = {
    "sidebar_hide_name": False,
    "navigation_with_keys": True,
    "dark_css_variables": {
        "color-brand-primary": "#7c6af7",
        "color-brand-content": "#7c6af7",
    },
    "light_css_variables": {
        "color-brand-primary": "#4a3fd4",
        "color-brand-content": "#4a3fd4",
    },
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/Marco-Christiani/jaxley-extracellular",
            "html": """
